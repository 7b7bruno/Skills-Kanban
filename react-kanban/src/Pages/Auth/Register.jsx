...
export default function Register() {
    ...
    return (
        <>
            ...
            <form onSubmit={handeRegister} className="w-1/2 mx-auto space-y-6">
                <div>
                ...
                <div>
                    <input type="password" placeholder="Pasword" value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })}/>
